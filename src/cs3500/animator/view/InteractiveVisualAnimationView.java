...
public class InteractiveVisualAnimationView implements IVisualAnimationView {
  protected InteractivePanel panel;
  protected InteractiveFrame frame;
  protected IVisualAnimationView delegate;
   ...
   */
  public InteractiveVisualAnimationView(IViewModel viewModel, int speed) {
  ...
  public void outlineShapesView() {
    throw new UnsupportedOperationException("Operation " +
      "currently unsupported for this type of view");
  }
