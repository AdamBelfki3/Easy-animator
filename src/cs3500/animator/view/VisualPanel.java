...
public class VisualPanel extends JPanel implements IAnimationPanels {
   ...
   *                  accordingly
   */
  public VisualPanel(int speed, IViewModel viewModel) {
  ...
  protected void updateSlowMoSpeed() {
    throw new UnsupportedOperationException("slow motion tempos are not available for this panel");
  }
