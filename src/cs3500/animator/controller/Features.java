...
public interface Features {
  ...
  /**
   * Displays the shape with just an outline, in other words, the color is not filled in.
   */
  public void outlineShapes();

  /**
   * Ability to display our animation in discrete frames instead of continuous. In other
   * words, it would display the animation's start and then immediately change to the animation's
   * end time so that it looks like the animation is being fast forwarded.
   */
