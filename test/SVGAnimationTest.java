...
import cs3500.animator.model.SimpleAnimationPlus;
...
public class SVGAnimationTest {
  ...
  // svg output with plus sign
  @Test
  public void renderViewPlusSign() {
    AnimationModel model = new SimpleAnimationPlus();

    model.setBounds(200, 70, 360, 360);
    model.createShape("plus", "P");
    model.createShape("ellipse", "C");
    model.addOperation("P", 10, 50, 300, 300, 50, 100, 255, 0,
        0);
    model.addOperation("P", 1, 10, 10, 200, 50, 100, 255, 0,
        0);
    model.addOperation("P", 50, 51);
    model.addOperation("P", 51, 70, 300, 300, 50, 100, 255, 0,
        0);
    model.addOperation("C", 6, 20, 400, 70, 120, 60, 0, 0,
        255);
    model.addOperation("C", 70, 80, 440, 370, 120, 60, 0, 255,
    ...
    model.addOperation("C", 80, 100, 440, 370, 120, 60, 0, 255,
        0);
    model.addOperation("P", 70, 100, 200, 200, 25, 100, 255, 0,
        0);
    ...
    IAnimationView view = new SVGAnimationPlus(viewModel, out1, 5);
    ...
    assertEquals("<svg width=\"360\" height=\"360\" version=\"1.1\"\n" +
        "     xmlns=\"http://www.w3.org/2000/svg\">\n" +
        "<rect id=\"PV\" x=\"-197\" y=\"-200\" width=\"3\" height=\"10\" " +
        "fill=\"rgb(255,0,0)\" visibility=\"visible\" >\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"19800ms\" " +
        "attributeName=\"visibility\" from=\"visible\" to=\"visible\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"x\" from=\"-197\" to=\"-174\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"y\" from=\"-70\" to=\"130\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"width\" from=\"3\" to=\"16\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"height\" from=\"10\" to=\"100\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"fill\" from=\"rgb(0, 0, 0)\" to=\"rgb(255, 0, 0)\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"x\" from=\"-173\" to=\"116\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"y\" from=\"130\" to=\"230\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"width\" from=\"16\" to=\"16\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"height\" from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"fill\" from=\"rgb(255, 0, 0)\" to=\"rgb(255, 0, 0)\" " +
        "fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"x\" from=\"117\" to=\"116\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"y\" from=\"230\" to=\"230\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"width\" from=\"16\" to=\"16\" fill=\"freeze\" />\n" +
        ...
        " fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"x\" from=\"117\" to=\"8\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"y\" from=\"230\" to=\"130\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"width\" from=\"16\" to=\"8\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"height\" from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"fill\" from=\"rgb(255, 0, 0)\" to=\"rgb(255, 0, 0)\" " +
        ...
        "</rect>\n" +
        "\n" +
        "<rect id=\"PHG\" x=\"-200\" y=\"-197\" width=\"10\" height=\"3\" " +
        "fill=\"rgb(255,0,0)\" visibility=\"visible\" >\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"19800ms\" " +
        "attributeName=\"visibility\" from=\"visible\" to=\"visible\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"x\" from=\"-200\" to=\"-190\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"y\" from=\"-67\" to=\"163\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"width\" from=\"10\" to=\"50\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"height\" from=\"3\" to=\"33\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"200ms\" dur=\"1800ms\" " +
        "attributeName=\"fill\" from=\"rgb(0, 0, 0)\" to=\"rgb(255, 0, 0)\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"x\" from=\"-190\" to=\"100\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"y\" from=\"163\" to=\"263\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\"" +
        " attributeName=\"width\" from=\"50\" to=\"50\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"height\" from=\"33\" to=\"33\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"2000ms\" dur=\"8000ms\" " +
        "attributeName=\"fill\" from=\"rgb(255, 0, 0)\" to=\"rgb(255, 0, 0)\" " +
        "fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"x\" from=\"100\" to=\"100\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"y\" from=\"263\" to=\"263\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"width\" from=\"50\" to=\"50\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"200ms\" " +
        "attributeName=\"height\" from=\"33\" to=\"33\" fill=\"freeze\" />\n" +
        ...
        "attributeName=\"x\" from=\"100\" to=\"0\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"y\" from=\"263\" to=\"163\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"width\" from=\"50\" to=\"25\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"14000ms\" dur=\"6000ms\" " +
        "attributeName=\"height\" from=\"33\" to=\"33\" fill=\"freeze\" />\n" +
        ...
        "</rect>\n" +
        "\n" +
        "<ellipse id=\"C\" cx=\"-200\" cy=\"-200\" rx=\"10\" ry=\"10\" " +
        "fill=\"rgb(255,0,0)\" visibility=\"visible\" >\n" +
        "<animate attributeType=\"xml\" begin=\"1200ms\" dur=\"18800ms\" " +
        "attributeName=\"visibility\" from=\"visible\" to=\"visible\" fill=\"freeze\" />\n" +
        "<animate attributeType=\"xml\" begin=\"1200ms\" dur=\"2800ms\" " +
