...
public class ListenerInteractiveTest {
  ...
  Features controllerPlus = new AnimationControllerInteractivePlus((InteractiveViewPlus) mockView);
  ...
  @Test
  public void testOutlineShape() {
    controllerPlus.outlineShapes();
    assertTrue(log.toString().contains("outline the shapes in animation\n"));
  }

  @Test
  public void testDiscreteFrame() {
    controllerPlus.discreteFrame();
    assertTrue(log.toString().contains("discrete frame animation render\n"));
  }
